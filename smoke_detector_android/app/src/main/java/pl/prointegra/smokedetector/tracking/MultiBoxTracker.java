...
package pl.prointegra.smokedetector.tracking;
...
public class MultiBoxTracker {
  ...
  private Runnable removePreview;
  ...
  public synchronized void draw(final Canvas canvas) {
    ...
    if (previewImage != null) {
      canvas.drawBitmap(previewImage, frameToCanvasMatrix, null);
    }
    ...
    for (final TrackedRecognition recognition : trackedObjects) {
      ...
      String labelString = recognition.label.getText();
  ...
  private void processResults(final List<Recognition> results) {
    ...
    for (final Pair<Float, Recognition> potential : rectsToTrack) {
      ...
      trackedRecognition.label = potential.second.getLabel();
      trackedRecognition.color = potential.second.getLabel().getColor();
...
//      }
  ...
  public void setPreviewImage(Bitmap image) {
    ...
    handler.removeCallbacks(removePreview);
    removePreview = () -> {
      previewImage = null;
      trackedObjects.clear();
    };
    handler.postDelayed(removePreview, 2000);
  }
